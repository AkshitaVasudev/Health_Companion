...
def get_db():
    db_path = os.path.join(os.getcwd(), 'health_companion.db')
...
label_encoder.classes_ = np.load('label_encoder_functional.npy')
vectorizer = CountVectorizer()
vectorizer.vocabulary_ = np.load('vectorizer_functional.npy', allow_pickle=True).item()


model = load_model('intent_classification_model_functional.h5')
